...
This document provides a detailed technical explanation of the "AI Stock Prediction System" (AI-Stock Pred). Use this to understand the underlying logic and architecture.
